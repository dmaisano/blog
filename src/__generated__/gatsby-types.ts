...
enum SiteFieldsEnum {
  ...
  siteMetadata___externalLinks = 'siteMetadata.externalLinks',
...
enum SitePageFieldsEnum {
  ...
  context___excerpt = 'context.excerpt',
  context___body = 'context.body',
  context___timeToRead = 'context.timeToRead',
...
type SiteSiteMetadata = {
  ...
  readonly externalLinks: Maybe<ReadonlyArray<Maybe<Scalars['String']>>>;
  readonly navigation: Maybe<ReadonlyArray<Maybe<Scalars['String']>>>;
};
...
type SiteSiteMetadataFilterInput = {
  ...
  readonly externalLinks: Maybe<StringQueryOperatorInput>;
  readonly navigation: Maybe<StringQueryOperatorInput>;
};
...
type cUsersriverProjectsblogsrccomponentsseoTsx63159454QueryVariables = Exact<{ [key: string]: never; }>;


type cUsersriverProjectsblogsrccomponentsseoTsx63159454Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'description' | 'author'>> }> };
...
type cUsersriverProjectsblogsrcpagesusingTypescriptTsx2190837200QueryVariables = Exact<{ [key: string]: never; }>;


type cUsersriverProjectsblogsrcpagesusingTypescriptTsx2190837200Query = { readonly site: Maybe<Pick<Site, 'buildTime'>> };
